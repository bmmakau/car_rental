...
$query -> execute();
$msg="Park Area updated  successfully";
...
<head>
	...
	<title>CPTMS |Admin Manage Parks   </title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Manage Parks</h2>

						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">Listed  Parks</div>
...
{				?>	
										<tr>
											...
											<td><?php echo htmlentities($result->lots);?></td>
											<td><?php echo htmlentities($result->booked);?></td>
											<td><?php echo htmlentities($result->shaded);?></td>
