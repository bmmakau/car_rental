...
<li><a href="#"><i class="fa fa-files-o"></i>Parking Areas</a>
<ul>
<li><a href="create-brand.php">Add Parking</a></li>
<li><a href="manage-brands.php">Manage Parks</a></li>
</ul>
</li>

<li><a href="#"><i class="fa fa-car"></i> Workers</a>
					<ul>
						<li><a href="post-avehical.php">Add Worker</a></li>
						<li><a href="manage-vehicles.php">Manage Workers</a></li>
					</ul>
				</li>
...
<li><a href="#"><i class="fa fa-sitemap"></i> Bookings</a>
			...
			<li><a href="update-contactinfo.php"><i class="fa fa-files-o"></i> Update Contact Infomation</a></li>
