...
$id=intval($_GET['bid']);								
$sql = "SELECT * from tblbooking, tblusers,tblbrands where tblbooking.EmailId=tblusers.EmailId && tblbooking.pid=tblbrands.id ";
$query = $dbh -> prepare($sql);
...
<tr>
	...
	<th>Status</th>
	<td><?php echo htmlentities($ppdays=$result->status);?></td>
</tr>
<!-- <tr>
